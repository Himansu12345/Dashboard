...
export const RAW_D = [
 {
    ...
    "children": [
      ...
      {
        "label": "PYQ-Driven — Harappan Architecture & Urban Planning",
        "kind": "comparison",
        "children": [
          {
            "label": "🟡|Salient features: planned streets/drainage, standardized burnt bricks, citadel–lower town pattern at several sites, wells, bathing structures, granaries/warehouses in some sites, and sophisticated water management.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Great Bath at Mohenjo-daro → large public water structure; Lothal → dockyard-like structure and maritime trade association.",
            "kind": "bullet"
          },
          {
            "label": "🟡|PYQ lens: Harappan urbanism reflects civic planning, sanitation, water management and organised craft/trade, but avoid claiming a single uniform municipal model for every site.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Contemporary relevance: principles of drainage, zoning, water harvesting and waste management offer useful precedents for resilient urban planning.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Temple Architecture as Social Life",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Temple complexes were not only sacred spaces; they supported patronage, land grants, craft production, festivals, education, social gathering and redistribution.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Sculptural programmes depict dancers, musicians, occupations, animals, erotic themes, warfare and everyday life, allowing historians to reconstruct aspects of social and cultural life.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Chola temples especially show the interaction of religion, state power, agrarian surplus, craft guilds and regional economy.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Chola Architecture High-Yield",
        "kind": "comparison",
        "children": [
          {
            "label": "🟡|Dravida architecture reaches a major high point under the Cholas: axial planning, towering vimanas, enclosed complexes, sculptural programmes and increasingly elaborate temple institutions.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Brihadisvara, Gangaikondacholapuram and Airavateshvara are key examples; architecture projected imperial power while integrating the agrarian-temple economy.",
            "kind": "bullet"
          },
          {
            "label": "🟡|The mature Chola temple combined sacred, political, economic and cultural functions rather than being only a place of worship.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Pallava Contribution",
        "kind": "comparison",
        "children": [
          {
            "label": "🟡|Pallavas of Kanchipuram were pivotal in the transition from rock-cut experimentation to structural South Indian temples.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Mahabalipuram: Pancha Rathas, Arjuna's Penance/Descent of the Ganga, Shore Temple; Kanchipuram: Kailasanatha Temple.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Pallava patronage also supported Sanskrit and Tamil learning and helped shape later Chola architectural traditions.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Chandela/Khajuraho",
        "kind": "comparison",
        "children": [
          {
            "label": "🟡|Khajuraho under the Chandellas: curvilinear shikhara, clustered subsidiary spires, sculptural profusion, balanced architectural composition and richly varied human/divine imagery.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Sculptures convey religious, courtly, social and aesthetic life; erotic imagery is one component, not the defining whole of Chandella art.",
            "kind": "bullet"
          },
          {
            "label": "🟡|PYQ phrase 'resilient vigor and breadth of life' is best answered through dynamism, volume, movement, ornamentation and the wide range of depicted human experience.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Taxila and Centres of Learning",
        "kind": "comparison",
        "children": [
          {
            "label": "🟡|Taxila was a major ancient centre of learning and a strategic node on routes linking South Asia with Central Asia; it attracted teachers/students in multiple disciplines.",
            "kind": "bullet"
          },
          {
            "label": "🟡|It was not a 'university' in the modern institutional sense of one centrally administered residential campus like Nalanda.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Nalanda developed a large monastic-residential institutional complex with organised teaching and patronage.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Civilisational Continuity, with Change",
        "kind": "comparison",
        "children": [
          {
            "label": "🟡|Indian cultural continuity is visible in recurring religious motifs, sacred geographies, pilgrimage traditions, languages, epics, ritual practices and artistic forms.",
            "kind": "bullet"
          },
          {
            "label": "🟡|But continuity is not unchanged survival: forms were repeatedly transformed through regionalisation, new religions, patronage shifts, technological change and interaction with Central Asian, Persian, Greek, Roman and other traditions.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "PYQ-Driven — Lion & Bull in Indian Art and Mythology",
        "kind": "comparison",
        "children": [
          {
            "label": "🟡|Lion → power, royalty, guardianship, courage and dharmic sovereignty; the Sarnath Lion Capital became the national emblem.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Bull → fertility, strength and agrarian abundance; Nandi is Shiva's vahana and the bull has deep Shaiva and broader Indic symbolic associations.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Bull and lion also occur in Mauryan/Harappan/temple iconography, showing continuity and transformation of animal symbolism across periods.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Gandhara: Greek + Roman + Central Asian",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Greek/Hellenistic contribution: naturalistic anatomy, idealised modelling, wavy hair and classical compositional vocabulary.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Roman contribution: deep-drilled hair, heavy folded drapery resembling toga, spatial treatment and certain sculptural techniques transmitted through the Roman/Greco-Roman world.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Central Asian/Kushan context supplied patronage, routes and cultural interaction; Gandhara was a syncretic Buddhist art region, not a simple 'Greek copy'.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Pala Buddhist Art",
        "kind": "comparison",
        "children": [
          {
            "label": "🟡|Pala period was a major phase of Buddhist intellectual and artistic vitality in eastern India, associated with Mahayana/Vajrayana traditions and centres such as Nalanda and Vikramashila.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Pala sculpture is known for elegant bronze and stone images, refined iconography and sophisticated modelling; Pala manuscript painting also influenced the wider Buddhist world.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Pala patronage supported transregional links with Tibet and Southeast Asia.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "PYQ-Driven — Mesolithic Rock Art",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Mesolithic rock art, especially at Bhimbetka, records hunting, animals, group activities, dancing and aspects of social life through simple but expressive forms.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Its value lies in combining evidence of livelihood, symbolic culture and aesthetic expression; avoid equating it mechanically with modern painting techniques.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "PYQ Direct Recall — Classical Dances & PYQ Traps",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|The eight classical dance forms listed in the standard Indian framework are Bharatanatyam, Kathak, Kathakali, Kuchipudi, Manipuri, Mohiniyattam, Odissi and Sattriya.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Yakshagana is a traditional theatre/dance-drama form of Karnataka, not one of the eight classical dances.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Garba is a folk dance/tradition of Gujarat; Mohiniyattam is Kerala; Sattriya is Assam; Odissi is Odisha.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Thang-Ta is a martial tradition of Manipur; Mayurbhanj Chhau is unmasked, while Purulia and Seraikela Chhau use masks.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Tandava",
        "kind": "comparison",
        "children": [
          {
            "label": "🟡|Tandava is associated with vigorous/dynamic manifestations of Shiva's dance; inscriptions and literary traditions connect it with cosmic power, destruction and rhythmic energy.",
            "kind": "bullet"
          },
          {
            "label": "🟠|For a Mains answer, distinguish Tandava as a broader Shivaic dance concept from later codified dance traditions and regional performance forms.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "PYQ-Driven — Folk Theatre & Cultural Continuity",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Indian theatre traditions combine music, dance, narrative, ritual and community performance; forms such as Yakshagana, Jatra, Bhavai, Therukoothu, Ankiya Nat and Nautanki transmit local history and social values.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Traditional performance often blends sacred and secular functions, making theatre an important carrier of language, memory and regional identity.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "PYQ Direct Recall — Literature/Terminology",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Parivrajaka → renunciant/wanderer.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Shramana → broad ascetic/renunciant traditions outside or parallel to the Vedic ritual order; includes diverse Buddhist, Jain and Ajivika streams.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Upasaka → lay male follower of Buddhism; Upasika → lay female follower.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Nettipakarana → Buddhist/Pali tradition; Parishishtaparvan → Jain historical/literary tradition; Avadanashataka → Buddhist narratives; Trishashtilakshana Mahapurana → Jain tradition.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Bhakti literature expanded vernacular religious expression and carried ethical, social and devotional themes beyond elite Sanskritic circles.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Bhakti, Chaitanya & Sufi Literature",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Bhakti literature is diverse: devotional, lyrical, vernacular and often critical of ritual exclusivity; it contributed to regional languages, music and social communication.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Chaitanya Mahaprabhu reoriented Bhakti in Bengal/Orissa through ecstatic Krishna devotion, sankirtana and intense congregational worship.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Sufi literature and institutions—khanqahs, malfuzat, tazkiras and poetic traditions—helped spread ethical, mystical and vernacular idioms.",
            "kind": "bullet"
          },
          {
            "label": "🟠|PYQ lens: Bhakti and Sufi traditions influenced culture and social interaction, but did not uniformly abolish caste or transform every social structure.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "PYQ-Driven — Akbar's Religious Syncretism",
        "kind": "comparison",
        "children": [
          {
            "label": "🟡|Akbar moved from a relatively conventional Sunni court identity toward a broader imperial ethic of sulh-i-kul (universal peace/tolerance).",
            "kind": "bullet"
          },
          {
            "label": "🟡|Ibadat Khana debates brought different religious scholars into dialogue; Akbar reduced the political dominance of orthodox clerical authority at court.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Din-i Ilahi/Tauhid-i-Ilahi was a small ethical-spiritual order around the emperor, not a mass religion replacing Islam.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Syncretism involved intellectual dialogue, translation projects, court culture and selective incorporation of ideas; it should not be overstated as doctrinal fusion of all religions.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Philosophy & Indian Monuments",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Indian philosophical traditions influenced symbolism, iconography, sacred geometry, cosmology and spatial organisation in monuments.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Buddhist stupas embody relic, cosmological and pilgrimage symbolism; Hindu temples express the axis mundi/cosmic mountain idea, sacred geometry and deity-centred spatial hierarchy.",
            "kind": "bullet"
          },
          {
            "label": "🟡|Jain architecture emphasises tirthankara imagery, purity and sacred pilgrimage landscapes; Islamic architecture introduced new geometric, calligraphic and spatial vocabularies while interacting with Indian building traditions.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Sufis & Medieval Mystic Traditions",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Sufi and Bhakti traditions encouraged vernacular expression, devotional practice and new social networks around saints, khanqahs and congregations.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Their impact was substantial in religious-cultural life and language, but they did not completely transform the institutional structure of Hindu or Muslim societies.",
            "kind": "bullet"
          },
          {
            "label": "🟠|For the PYQ, a balanced answer should distinguish cultural/religious influence from structural social transformation.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Religious/Philosophical Crossovers",
        "kind": "comparison",
        "children": [
          {
            "label": "🟡|Mahayana: bodhisattva ideal, image worship and expanded devotional practices; Theravada preserves the arhat ideal and Pali textual tradition.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Paramitas = perfections cultivated on the bodhisattva path; commonly listed as dana, sila, kshanti, virya, dhyana and prajna.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Indian philosophical schools influence art through concepts of dharma, karma, moksha, cosmic order and the nature of divinity/ultimate reality.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Heritage Safeguarding",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Heritage conservation requires documentation, preventive conservation, scientific restoration, site management, control of illicit trafficking, community participation and heritage-sensitive urban development.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Safeguarding should cover both tangible heritage (monuments/artefacts) and intangible heritage (dance, music, crafts, rituals, languages and oral traditions).",
            "kind": "bullet"
          },
          {
            "label": "🟡|Major pressures: urbanisation, pollution, tourism load, climate/water damage, encroachment, neglect and loss of traditional practitioners.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "PYQ Direct Recall — Material Culture & Regional Crafts",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Chanderi → famous for handwoven textiles/sarees; Kancheepuram → silk sarees; Bhadrachalam is not a standard PYQ silk/textile pairing in the cited question.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Panchayatana → temple plan with a principal shrine and four subsidiary shrines at the corners, generally arranged on a common platform.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Chausath Yogini temples → circular open-air/shrine complexes dedicated to 64 Yoginis; do not associate them with Vaishnava temple planning.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ-Driven — Pottery, Textiles & Cultural Material",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Material culture questions often combine object + region + technique: Chanderi textiles, Kancheepuram silk, Kalamkari, Thanjavur painting, Chola bronzes and regional crafts are high-yield pairings.",
            "kind": "bullet"
          },
          {
