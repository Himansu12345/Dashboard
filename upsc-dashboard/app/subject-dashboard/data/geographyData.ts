...
export const RAW_D = [
   {
    ...
    "children": [
      ...
      {
        "label": "PYQ Direct Recall — Primary Rocks & Tectonic Features",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Primary rocks = igneous rocks, formed by cooling/solidification of magma or lava; the other two major rock classes form through sedimentation or metamorphism.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Mantle plume → localized upwelling of unusually hot mantle material; can produce hotspot volcanism away from plate boundaries.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Circum-Pacific Ring of Fire → belt of intense tectonic activity around the Pacific, with frequent earthquakes and volcanic activity.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Major mountain ranges generally align with plate boundaries or past tectonic zones; their orientation influences winds, rainfall, temperature and local climate.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      },
      {
        ...
        "children": [
          ...
          },
          {
            ...
            "children": [
              {
                "label": "🔴|Coriolis Force: apparent deflection right in NH, left in SH; zero at the equator and increasing toward the poles."
              },
              {
      ...
      {
        "label": "PYQ Direct Recall — Cloudburst, Cyclone & Tornado",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Cloudburst → very intense rainfall over a small area in a short time, commonly associated with deep convective clouds; in India it can be especially hazardous in hilly terrain because of steep runoff and landslides.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Tropical cyclone genesis needs warm ocean water, abundant moisture, sufficient Coriolis force, a pre-existing disturbance and relatively low vertical wind shear.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Rising sea-surface temperature can increase evaporation/moisture supply and the potential intensity of tropical cyclones, but SST alone does not determine cyclone formation.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Tornado/twister → narrow, violently rotating column of air extending from a severe thunderstorm to the surface.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Gulf of Mexico/central USA → warm moist Gulf air meets colder/drier continental air, with strong vertical wind shear and a broad flat landmass favourable for severe thunderstorms and tornado formation.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ Direct Recall — Aurora & Colour-Coded Warnings",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Aurora Borealis → Northern Hemisphere; Aurora Australis → Southern Hemisphere.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Auroras occur when energetic charged particles associated with the solar wind are guided by Earth's magnetic field toward polar upper-atmosphere regions, exciting gases that emit light.",
            "kind": "bullet"
          },
          {
            "label": "🔴|India Meteorological Department cyclone warnings use colour codes to communicate increasing levels of expected impact/action: Green—no warning; Yellow—be aware; Orange—be prepared; Red—take action.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Indian Monsoon & Purvaiya",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Purvaiya in the Bhojpur region refers to the easterly/southeasterly character of the monsoon winds there, linked to the Bay of Bengal branch and regional pressure/wind circulation.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Monsoon Asia's high population support reflects seasonal concentration of rainfall, warm growing conditions, fertile alluvial/volcanic soils in many areas, multiple cropping and irrigation.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Monsoon variability creates both opportunity and risk: crop cycles depend on timing, spatial distribution and intensity of rainfall rather than annual total alone.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Cryosphere & Contrasting Polar Effects",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Arctic sea-ice loss primarily affects albedo, ocean-atmosphere heat exchange and circulation in the Northern Hemisphere; it does not directly raise global sea level like melting land ice.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Antarctic land-ice/glacier loss contributes directly to sea-level rise; changes in Southern Ocean circulation, ice shelves and atmospheric patterns affect climate and human activities.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Himalayan glacier loss initially changes runoff and later threatens dry-season water availability, hydropower, irrigation and downstream ecosystems.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "PYQ Direct Recall — Ocean Currents & Fishing",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Ocean currents are influenced by winds, Coriolis force, temperature/salinity density differences, pressure gradients, configuration of coasts and ocean basins.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Cold currents along western continental margins can enhance coastal upwelling; nutrient-rich deeper water supports high marine productivity and major fisheries.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Warm currents can moderate coastal climates and alter evaporation/precipitation; convergence and divergence zones strongly influence biological productivity.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ Direct Recall — Ocean Salinity & Water Masses",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Ocean salinity varies with evaporation, precipitation, river inflow, freezing/melting of sea ice and ocean-current mixing.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Highest surface salinity generally occurs in subtropical high-pressure belts where evaporation exceeds precipitation; lower salinity occurs near heavy-rainfall equatorial zones and high-latitude meltwater regions.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Water mass = large body of seawater with relatively uniform temperature and salinity acquired in its formation region; density differences help drive deep-ocean circulation.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Coastal & Marine Resources",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Long Indian coastline offers ports, shipping, fisheries, aquaculture, offshore hydrocarbons, marine tourism, renewable energy, coastal agriculture and blue-economy opportunities.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Coastal hazards include cyclones, storm surges, erosion, tsunamis, saline intrusion and sea-level rise; preparedness requires early warning, resilient infrastructure, mangroves/coral reefs, evacuation planning and coastal zoning.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Mangroves and coral reefs act as coastal bioshields while supporting biodiversity, fisheries and livelihoods.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Coral, Mangroves & Ocean Warming",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Coral bleaching occurs when heat stress disrupts the coral–zooxanthellae relationship; repeated/severe bleaching can cause mortality and reef degradation.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Mangrove loss is driven by aquaculture/urban expansion, pollution, altered freshwater flows, over-exploitation and coastal infrastructure.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Ocean warming and acidification create combined stress on marine ecosystems: warming promotes bleaching while acidification reduces calcification capacity in many organisms.",
            "kind": "bullet"
          }
        ]
      },
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "MAINS PYQ — Groundwater, Rivers & Water Security",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Gangetic groundwater decline can reduce irrigation reliability, raise pumping costs, intensify energy demand and threaten crop yields and food security where surface-water alternatives are limited.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Key drivers: intensive irrigation, water-intensive crops, groundwater-dependent agriculture, urban/industrial extraction, declining recharge and altered river–aquifer interactions.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Water security needs demand management, crop diversification, recharge/wetland protection, efficient irrigation, conjunctive use of surface and groundwater and basin-level governance.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — India as a Subcontinent",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|India is described as a subcontinent because of its large size, distinct physiographic structure, Himalayan barrier, peninsular plateau, surrounding seas, monsoon system and long historical-geographical unity with marked internal diversity.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Water Bodies & Urbanisation",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Converting urban water bodies to built-up land reduces natural storage, blocks drainage, increases runoff and urban heat, destroys biodiversity and increases flood risk.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Restoration should protect floodplains/wetlands, reconnect drainage channels, increase permeable surfaces, use rainwater harvesting and integrate blue-green infrastructure into city planning.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "MAINS PYQ — Climate Change, Food Security & Vegetation",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Climate change threatens food security through heat stress, rainfall variability, drought/flood extremes, pest shifts, glacier/runoff changes and coastal salinisation.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Tropical countries are particularly exposed because high heat, monsoon variability and dependence on climate-sensitive agriculture interact with existing poverty and limited adaptive capacity.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Natural vegetation diversity in India reflects latitude, monsoon rainfall, temperature, altitude, soils and relief; rainfall seasonality is especially important in differentiating forest types.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Rainforest wildlife sanctuaries protect biodiversity, watershed functions and ecological connectivity, but effectiveness depends on habitat integrity, local community participation and control of fragmentation.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Food Exporter Transition",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|India moved from food shortages/import dependence to net food exports through Green Revolution technologies, irrigation, improved seeds/fertiliser use, procurement and MSP systems, agricultural research, expansion of production and diversification.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Export capacity is uneven: rice, marine products, spices, sugar and some horticultural commodities are important, while pulses and edible oils remain structurally more import-dependent.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Natural Vegetation & Wildlife",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Vegetation responds to rainfall amount/seasonality, temperature, soil, altitude and latitude; human pressure modifies the natural pattern through agriculture, logging, fire and infrastructure.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Protected areas in rainforest regions conserve endemism, genetic diversity, watershed services and carbon stocks, but need landscape-level connectivity and community-inclusive management.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "PYQ Direct Recall — Straits, Isthmuses & Strategic Geography",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Strait → narrow natural water passage connecting two larger water bodies; strategically important for shipping, naval mobility and chokepoint security.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Isthmus → narrow land bridge joining two larger landmasses and separating two water bodies; can have major canal/transport significance.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Examples: Strait of Malacca—Indian Ocean–Pacific trade route; Strait of Hormuz—Persian Gulf energy chokepoint; Bosporus/Dardanelles—Black Sea–Mediterranean connection; Isthmus of Suez is largely a canalised transport corridor.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ Direct Recall — Mineral Oil & Global Distribution",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Major world petroleum concentrations reflect sedimentary basins and geological history; the Middle East, North America, Russia/Caspian region and other major basins are key producing areas.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Uneven distribution creates trade dependence, strategic chokepoints, price vulnerability, geopolitical competition and pressure for diversification of energy sources.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "MAINS PYQ — Wind & Solar Energy in India",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Wind potential is strongest in high-wind corridors such as coastal areas and selected interior ridges; spatial spread is constrained by wind regime, terrain, grid connectivity, land availability, project economics and intermittency.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Solar potential is high across much of India but varies with insolation, cloud cover, latitude, dust, land constraints, transmission capacity and storage needs.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Energy transition requires grid upgrades, storage, hybridisation, forecasting, transmission from renewable-rich regions and flexible demand.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Mining & Manufacturing",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Despite mineral abundance, mining's GDP contribution is limited by environmental constraints, land/forest restrictions, fragmented governance, infrastructure/logistics gaps, technology, exploration risk and value-addition weaknesses.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Regional resource-based manufacturing can generate employment by locating processing near raw materials, reducing transport costs and building local value chains; success depends on skills, market access, infrastructure and environmental safeguards.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Agro-based food processing localises near raw materials, markets, transport, labour, water and cold-chain facilities; North-West India has strong cereal, dairy and horticultural processing potential.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "PYQ Direct Recall — Crops, Rubber & Petroleum Refineries",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|Pulses improve soil nitrogen through biological fixation, require relatively less water in many contexts, provide affordable protein and support crop diversification; they can also fit well into dryland systems.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Rubber plantations concentrate in humid tropical regions; environmental concerns include biodiversity loss, monoculture, soil erosion, chemical use and land-use change.",
            "kind": "bullet"
          },
          {
            "label": "🔴|Petroleum refineries may locate away from crude fields because transport of crude can be cheaper/easier than transporting multiple refined products; refinery sites also depend on ports, markets, pipelines, water, labour and infrastructure.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Coal & Development",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Coal remains important because of existing power/industrial capacity, domestic reserves and reliability, but extraction causes land degradation, displacement, air/water pollution and greenhouse-gas emissions.",
            "kind": "bullet"
          },
          {
            "label": "🟠|A just transition needs clean technologies, mine-land reclamation, worker reskilling, alternative livelihoods, renewable investment and region-specific economic diversification.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Blue Revolution & Pisciculture",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Blue Revolution = expansion and modernisation of fisheries/aquaculture to raise production, income, nutrition and exports.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Challenges: disease, feed costs, water quality, overfishing, cold-chain gaps, market access, coastal ecological stress and small-producer vulnerability.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Sustainable strategy: better hatcheries/feed, biosecurity, species diversification, responsible coastal aquaculture, fisher cooperatives, value addition and ecosystem-based fisheries management.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "MAINS PYQ — Demographic Winter & Human Development",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Demographic winter → prolonged below-replacement fertility leading to population ageing, shrinking working-age cohorts and eventual population decline.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Global movement is uneven: some advanced and East Asian societies face very low fertility and ageing, while parts of Africa/South Asia remain relatively young.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Economic development can outpace human development when growth is accompanied by weak health, education, nutrition, gender equality, employment quality and regional access to public services.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Water Stress & Freshwater Crisis",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Water stress arises when demand and withdrawals approach/exceed available renewable supply or when quality/affordability prevents effective access.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Global freshwater crisis has multiple dimensions: physical scarcity, pollution, unequal infrastructure/access, groundwater depletion, climate variability and poor governance.",
            "kind": "bullet"
          },
          {
            "label": "🟠|India's regional water stress is shaped by monsoon seasonality, population density, cropping patterns, groundwater dependence, urbanisation and interstate/intrabasin mismatches.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "MAINS PYQ — Climate, Desertification & Forests",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Desertification has no strict climate boundary because land degradation can arise in drylands as well as human-induced degradation in comparatively humid areas through deforestation, overgrazing, poor irrigation, mining and unsustainable cultivation.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Forest resources influence carbon storage, rainfall recycling, soil conservation, biodiversity and livelihoods; degradation can amplify climate vulnerability.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Mountain ecosystem restoration requires slope stabilisation, native vegetation, carrying-capacity-based tourism, watershed treatment, disaster-sensitive infrastructure and community stewardship.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Urban Flooding & Climate Resilience",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Urban flooding is intensified by concretisation, encroachment on floodplains/wetlands, inadequate drainage, waste blockage, loss of natural storage and extreme rainfall.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Long-term measures: restore wetlands, improve storm-water drainage, use permeable surfaces/rain gardens, protect floodplains, enforce land-use planning, improve early warning and adopt sponge-city/blue-green infrastructure approaches.",
            "kind": "bullet"
          }
        ]
      },
      {
        "label": "MAINS PYQ — Arctic & Mineral Resources",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|India's Arctic interest relates to climate science, monsoon linkages, polar research, sea-level and cryosphere changes, shipping possibilities, scientific cooperation and resources.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Critical mineral/petroleum concentration is geopolitically important because uneven spatial distribution creates supply-chain dependence and strategic vulnerability.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "MAINS PYQ — Industrial Corridors & Regional Planning",
        "kind": "comparison",
        "children": [
          {
            "label": "🟠|Industrial corridors integrate transport, logistics, manufacturing clusters, utilities and urban nodes along major connectivity routes.",
            "kind": "bullet"
          },
          {
            "label": "🟠|They can reduce logistics costs, attract investment and create jobs, but may also intensify regional inequality, land pressure and environmental stress if corridor development is not balanced.",
            "kind": "bullet"
          },
          {
            "label": "🟠|Examples commonly discussed in India include Delhi–Mumbai, Chennai–Bengaluru and Amritsar–Kolkata corridors.",
            "kind": "bullet"
          }
        ]
      }
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "label": "PYQ Direct Recall — IRNSS/NavIC & Geography Techniques",
        "kind": "comparison",
        "children": [
          {
            "label": "🔴|IRNSS/NavIC was developed to provide independent regional satellite navigation; it offers Standard Positioning Service for civilian users and Restricted Service for authorised users.",
            "kind": "bullet"
          },
          {
            "label": "🔴|GIS integrates spatial and attribute data through layers for mapping, analysis and decision-making; remote sensing supplies data from sensors, while GNSS provides location/positioning.",
            "kind": "bullet"
          },
          {
